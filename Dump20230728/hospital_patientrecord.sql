...
CREATE TABLE `patientrecord` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idpatient.record_UNIQUE` (`ID`)
...
INSERT INTO `patientrecord` VALUES (1,'asd','asd','asd','Dr. Nathaniel Daelo','asd','Female','asd','asd','asd','Antibiotic','asd','asd','asd','asd','asd'),(2,'1234','Mark','Mark','Dr. Bryle Molina','19','Male','Laguna','12/16/2003','o','Mefanamic','12','3','12/12/12','12/12/21','3');
...
-- Dump completed on 2023-07-28  1:14:18
